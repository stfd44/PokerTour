        ...
        <div className="space-y-3">
          ...
          {winner && (
            <div className="flex items-center justify-between p-3 rounded-lg bg-yellow-50 border border-yellow-300">
              <div className="flex items-center">
                <span className="text-lg font-bold text-yellow-600 mr-3">🏆 1er</span>
                <span className="font-medium text-gray-800">{winner.nickname || winner.name}</span>
              </div>
              <span className="text-sm font-semibold text-green-600">Vainqueur</span>
            </div>
          )}
          ...
          {eliminatedPlayers.map((player, index) => (
            <div key={player.id} className="flex items-center justify-between p-3 rounded-lg bg-gray-50 border border-gray-200">
              <div className="flex items-center">
                <span className="text-md font-semibold text-gray-600 mr-3">{index + 2}e</span>
